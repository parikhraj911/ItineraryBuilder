...
//initAutocomplete();
  ...
  $(document).on('click', '#rent',()=>{
      ...
      $("#airlineBuilderDiv").append('<b>Airline Name:</b> <input class="checkable" type = "text" id = "airlineName" placeholder = "Name your airline" ><p></p>');
      $("#airlineBuilderDiv").append('<b>Departure Airport Code:</b> <input class="checkable" type = "text" id = "departureAirport_b" placeholder = "Departure Airport Code" ><p></p>');
      $("#airlineBuilderDiv").append('<b>Departure Time:</b> <input class="checkable" type = "time" id = "departureTime_b" value="00:00" ><p></p>');
      $("#airlineBuilderDiv").append('<b>Arrival Airport Code:</b> <input class="checkable" type = "text" id = "arrivalAirport_b" placeholder = "Arrival Airport Code" ><p></p>');
      $("#airlineBuilderDiv").append('<b>Arrival Time:</b> <input class="checkable" type = "time" id = "arrivalTime_b" value="00:00" ><p></p>');
      $("#airlineBuilderDiv").append('<b>Flight Number:</b> <input class="checkable" type = "text" id = "number_b" placeholder = "Flight Number" ><p></p>');
      $("#airlineBuilderDiv").append("<b>Date:</b> <input class='checkable' type = 'date' id = 'date_b'  min='2018-10-12' placeholder = 'Date' > <span class='validity'></span> <p></p>");
...
$(document).on('click', '#submit',()=>{
  ...
  $("body").append("<button type='button' class='returnHome'>Return to Main Page</button>");
  ...
  for(i=0;i<instancesToSend.length;i++){
    ...
    //  console.log("departure id: "+flight.departure_id);
      ...
      $("#ticket-"+_id).append("<p class='ticketOwner Name First'> First Name: "+ticket.first_name+"</p>");
      $("#ticket-"+_id).append("<p class='ticketOwner Name Last'> Last Name: "+ticket.last_name+"</p>");
